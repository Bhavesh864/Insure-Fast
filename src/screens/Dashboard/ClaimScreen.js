...
import { Center, flexRow, fonts, screenStyle, width } from '../../styles/CommonStyling'
import { AppText, HeadingText } from '../../Utility/TextUtility';
import { colors } from '../../styles/colors';
import { shadows } from '../../styles/shadow';
import { navigate } from '../../routes/RootNavigation';
import { HomeHeader } from '../../components/home/HomeComponents';
import { getAllClaimOfCustomer, getPunchedPoliciesData } from '../../store/actions/PolicyAction';
...
const ClaimScreen = ({ navigation }) => {
    ...
    return (
        <View style={screenStyle}>
            ...
            {activeTab == 'plan' ? <TouchableOpacity activeOpacity={0.8} onPress={() => navigate("claimForm")} style={styles.claimReqCont}>
                <View>
                    <Image source={require("../../assets/images/other/flagFill.png")} style={styles.flagImg} />
                </View>
                <View>
                    <HeadingText
                        text={"Submit Cliam Request"}
                        size={16}
                    />
                    <AppText
            ...
            {
                activeTab == "plan" ?
                    <PlanComponent policiesList={policiesList} />
                    :
...
const TrackClaimComponent = ({ claimData }) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            {claimData && claimData.length === 0 ? <View style={{ position: "absolute", bottom: "40%", alignSelf: "center", alignItems: "center" }}>
                <HeadingText
                ...
                <>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item, index }) => {
                            return <TouchableOpacity activeOpacity={1} style={styles.claimReqCont} onPress={() => {
