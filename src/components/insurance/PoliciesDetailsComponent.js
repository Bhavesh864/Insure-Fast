...
const PoliciesDetailsComponent = ({ item }) => {
    ...
    return (
        <View style={styles.tabCont}>
            <View style={{ padding: 20, flexDirection: "row" }}>
                ...
                <View style={{ flex: 1, paddingLeft: 15 }}>
                    ...
                    <View style={{ paddingTop: 6, marginLeft: 3 }}>
                        ...
                        {/* <View style={{ ...flexRow, marginTop: 3 }}>
                            <MaterialIcons name='event-note' size={18} color={colors.darkGrey} />
                            <AppText text={` Reg No.--  ${item?.item?.customer?.motorInsurance?.vehicle_no}`} color={colors.darkGrey} />
                        </View> */}
            ...
            <View style={{ borderBottomWidth: 0.4, marginHorizontal: 20 }}>

            </View>
        </View >
    )
}
export default PoliciesDetailsComponent
