...
const ShareQuotationEmailModal = ({
  onClose,
  title = 'Select',
  list = [],
  onItemSelect,
  ...
  return (
    <SafeAreaView>
      <Modal visible transparent onRequestClose={onClose} animationType="slide">
        <CustomKeyboardAvoidingView behavior="padding" style={styles.modalCont}>
          <View style={styles.modalCont}>
            <View style={[styles.cont]}>
              <ModalTitleHeader title={title} onPress={onClose} />
              <View
                style={{
                  flexGrow: 1,
              ...
              <TouchableOpacity
                ...
                <AppText
                  ...
                  color={colors.white}
                  size={14}
                  style={{textAlign: 'right', padding: 15}}
                />
              </TouchableOpacity>
            </View>
          </View>
