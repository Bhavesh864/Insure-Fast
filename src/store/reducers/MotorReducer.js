...
const MotorReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case QUICK_QUOTE_RESULTS:
            ...
            let index = data.findIndex((item) => item.insurer === action.payload.insurer);
            if (index > -1) {
...
//             ElectricAmount: obj.AddOns.IsElectricalAccessories == true ? obj.AddOns.ElectricAmount : 0,
//             NonElectricAmount: obj.AddOns.IsNonElectricalAccessories == true ? obj.AddOns.NonElectricAmount : 0,
//             VoluntaryDeductiveAmount: obj.AddOns.VoluntaryDeductive == true ? obj.AddOns.VoluntaryDeductiveAmount : 0,
//             PassengerCoverAmount: obj.AddOns.PassengerCover === true ? obj.AddOns.PassengerCoverAmount : 0,
...
//             PreviousNoClaimBonus: obj.PreviousInsuranceClaimed == "false" ? obj.PreviousNoClaimBonus : 0,
...
//             ElectricAmount: reqObj.AddOns.IsElectricalAccessories == true ? reqObj.AddOns.ElectricAmount : 0,
//             NonElectricAmount: reqObj.AddOns.IsNonElectricalAccessories == true ? reqObj.AddOns.NonElectricAmount : 0,
//             VoluntaryDeductiveAmount: reqObj.AddOns.VoluntaryDeductive == true ? reqObj.AddOns.VoluntaryDeductiveAmount : 0,
//             PassengerCoverAmount: reqObj.AddOns.PassengerCover === true ? reqObj.AddOns.PassengerCoverAmount : 0,
...
//             PreviousNoClaimBonus: reqObj.PreviousInsuranceClaimed == "false" ? reqObj.PreviousNoClaimBonus : 0,
